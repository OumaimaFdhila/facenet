    ...
    return (
        <>
            <Modal size="3xl" isOpen={isOpen} onOpenChange={onOpenChange}>
                ...
                {(onClose) => (
                    <>
                        <ModalHeader className="flex dark flex-col gap-1 font-semibold text-vert_citron">Add user</ModalHeader>
                        <ModalBody>
                            <div className="pb-5">
                                <form  className="mt-4 space-y-4">
                                    ...
                                    isLoading={loading}
                                    type="submit"
                                    className="w-full text-yellow py-2 rounded-xl text-vert_citron "
                                    >
                                    Edit User
                                    </Button>
                                </form>
